    ...
    <div class="container login-container">
        <div class="row">
            <div class="col-sm-6 text-center">
                <img src="path/to/your/system-logo.png" alt="Login Image" class="img-responsive">
            </div>
            <div class="col-sm-6">
                <img src="path/to/your/system-logo.png" alt="System Logo" class="img-responsive">
                <h5>LOW CARBON MONITORING SYSTEM</h5>
                <form action="home">
                    <div class="input-group">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-user"></span>
                        </span>
                        <input type="text" name="utmid" placeholder="Username" class="form-control" />
                    </div>
                    <br />
                    <div class="input-group">
                        <span class="input-group-addon">
